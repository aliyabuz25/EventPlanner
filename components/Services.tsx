    ...
    <section id="services" className="py-24 bg-white dark:bg-[#0a0a0a] transition-colors duration-500 overflow-hidden">
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          ...
          <p className="reveal reveal-up delay-200 text-slate-600 dark:text-slate-400 max-w-md text-lg">
            {section.description}
          </p>
        </div>
        ...
        <div className="reveal reveal-up delay-300 mt-20 p-10 bg-[#f8fafc] dark:bg-[#121212] border-l-4 border-[#008FD3] flex flex-col lg:flex-row items-center justify-between gap-12 rounded-r-lg shadow-xl dark:shadow-xl transition-colors">
